...
const History = () => {
  ...
  const Row = ({ index, style }) => (
    <div style={{ ...style, display: 'flex', borderBottom: '1px solid white', color: 'white' }}>
      ...
      <div style={{ width: '30%', padding: '10px', overflowX: 'auto' }}>
        <DynamicResponse content={history[index].response} /> {/* Render the response using DynamicResponse */}
      </div>
    </div>
  );
